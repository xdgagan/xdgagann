...
from NoinoiRobot.__main__ import STATS, TOKEN, USER_INFO
import NoinoiRobot.modules.sql.userinfo_sql as sql
...
from NoinoiRobot.modules.sql.afk_sql import is_afk, check_afk_status
from NoinoiRobot.modules.sql.users_sql import get_user_num_chats
from NoinoiRobot.modules.helper_funcs.chat_status import sudo_plus
from NoinoiRobot.modules.helper_funcs.extraction import extract_user
from NoinoiRobot import telethn as YoneTelethonClient, TIGERS, DRAGONS, DEMONS
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>CURRENT NOINOI STATS</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
